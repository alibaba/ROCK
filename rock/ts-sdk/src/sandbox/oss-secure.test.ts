...
describe('OSS client configuration', () => {
  ...
  // OSS STS Credentials and isTokenExpired tests moved to oss_client.test.ts
  // The OssClient class now owns STS credential fetching and token expiration checks.
  // These behaviors are tested via OssClient unit tests.
